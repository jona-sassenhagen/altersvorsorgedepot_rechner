...
- Der Rechner bildet das im Mai 2026 in Kraft getretene Altersvorsorgereformgesetz für die ab 1. Januar 2027 vorgesehene neue Produktwelt nach.
- Maßgeblich für die Modellannahmen sind insbesondere die [aktuellen BMF-FAQ](https://www.bundesfinanzministerium.de/Content/DE/FAQ/reform-der-privaten-altersvorsorge.html) und § 22 Nummer 5 EStG.
...
Die App projiziert die Ansparphase und anschließend ein vereinfachtes Entnahmeszenario mit einem wählbaren anfänglichen jährlichen Entnahmesatz von 3 bis 5 Prozent (Standard: 4 Prozent). Tatsächliche Entnahmen sind auf das jeweilige Vermögen begrenzt. Die Einkommensteuer in der Auszahlungsphase wird im Nettovergleich modelliert; konkrete Anbieter-Auszahlungsprodukte und alternative Entnahmestrategien werden nicht erzwungen.
...
- Die App nimmt ausdrücklich an, dass die gesamte modellierte Steuererstattung wieder in das jeweilige Altersvorsorgedepot eingezahlt wird. Sie wird dort als **ungeförderter Eigenbeitrag mit Steuerbasis** geführt; das geschieht in der Realität nicht automatisch.
...
- Das AVD-Vermögen wird je Person in gefördertes und ungefördertes Kapital aufgeteilt. Eigenbeiträge bis EUR 1.800 je Kalenderjahr und die direkten Zulagen bilden gefördertes Kapital; übersteigende Beiträge und die modelliert reinvestierte Steuererstattung bilden ungefördertes Kapital mit fortgeführter Beitragsbasis. Erträge und Kosten werden den Teilvermögen getrennt zugerechnet. Entnahmen erfolgen proportional: Der geförderte Anteil ist vollständig steuerpflichtig, beim ungeförderten Anteil wird für den modellierten Depot-Auszahlungsplan nur der anteilige Unterschied zwischen Leistung und fortgeführter Beitragsbasis als Einkommen nach § 22 Nummer 5 Satz 2 Buchstabe c EStG angesetzt.
...
- Die Vorabpauschale nach § 18 InvStG wird am Jahresende ermittelt, aber erst zu Beginn des Folgejahres steuerlich erfasst. Der Basisertrag verwendet 70 Prozent des jeweiligen Basiszinses, wird im Erwerbsjahr monatsanteilig gekürzt und auf die positive Wertsteigerung begrenzt. Angesetzte Vorabpauschalen mindern später den Veräußerungsgewinn.
...
- Vorabpauschalen und realisierte Gewinne werden kalenderjährlich gemeinsam verrechnet. Negative Aktienfonds-Erträge werden nach der 30-prozentigen Teilfreistellung im ETF-Verlusttopf vorgetragen und nur mit späteren Kapitalerträgen des Modells verrechnet.
- Der Sparer-Pauschbetrag von EUR 1.000 je erwachsener Person wird im Modell vollständig dem ETF zugerechnet. In der Ansparphase wird mangels Arbeitseinkommensdaten die Abgeltungsteuer statt einer Günstigerprüfung verwendet.
...
Nicht enthalten sind Kirchensteuer, Transaktionskosten und weitere individuelle Frei- oder Abzugsbeträge. Der proportionale Verkauf zur Finanzierung der Vorabpauschalensteuer wird ohne zusätzlichen Veräußerungsgewinn auf diesen kleinen Steuerverkauf angenähert.
